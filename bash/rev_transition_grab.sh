...
do
	...
	do
		...
		do
			...
			do
				filename="./cssr_output/${p}/${p}_${a}_channel_${ch}_2500_rev_${lam}" # the name of the participant cssr files
				sourcename="./out/${p}_${a}_channel_${ch}_2500_rev"
